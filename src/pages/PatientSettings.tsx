...
import { Bell, Lock, User, Globe, MoonStar, Sun, Eye, EyeOff, HeartPulse } from 'lucide-react';
...
const PatientSettings = () => {
  ...
  const [appoinmentReminders, setAppoinmentReminders] = useState(true);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="col-span-1 lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <HeartPulse className="h-5 w-5 text-healthy-500" />
                  Health Data Sharing
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox id="share-doctors" defaultChecked />
                    <Label htmlFor="share-doctors">Share with my doctors</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox id="share-researchers" />
                    <Label htmlFor="share-researchers">Share anonymously with researchers</Label>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Receive notifications about your health</p>
                  </div>
                  <Switch 
                    ...
                    <div className="space-y-3 pt-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Switch 
                          ...
                          checked={appoinmentReminders} 
                          onCheckedChange={setAppoinmentReminders}
                        />
                      </div>
                      <div className="flex items-center justify-between">
